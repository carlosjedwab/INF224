...
public class Client
{
  ...
  static final String DEFAULT_HOST = "localhost"; /* The host where the server is running */
  static final int DEFAULT_PORT = 3331; /* The port where the server is listening */
  private Socket sock; /* The socket used to communicate with the server */
  private BufferedReader input; /* The input stream used to read the response from the server */
  private BufferedWriter output; /* The output stream used to send the request to the server */
